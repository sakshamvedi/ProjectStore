...
const [playicon7,setplayicon7] = React.useState("play.png");
                          ...
                          if(playson == true)
                          {
                            ...
                            setplayicon6("play.png")
                              ...
                              case "i" :
                                if(playson == true)
                                {
                                  playbtn7.current.play()
                                  setplayicon7("pause.png");
                                }
                                else{
                                  playbtn7.current.pause()
                                  setplayicon7("play.png")
...
<audio src='train.mp3' ref={playbtn7}></audio>
<div className={clas}>
<div className='mood'>
...
<p1><bold>Gentle Train</bold></p1>
  <br></br>
  <div className='playbtn' onClick={()=>playsong("i")}>
    <img src={playicon7 } ></img>
  </div>
